...
function IdPSelectUIParms(){
    ...
    //
    this.alwaysShow = false;          // If true, this will show results as soon as you start typing
    this.dataSource = '/localDiscoFeed.json';    // Where to get the data from
    this.defaultLanguage = 'en';     // Language to use if the browser local doesnt have a bundle
    this.defaultLogo = 'cdl_logo.gif';
    this.defaultLogoWidth  = 0;  // 198 ;
    this.defaultLogoHeight = 0;  // 71 ;
